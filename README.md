...
> El tiempo es movimiento. / Time is motion.
...
sede del sitio web del proyecto.

---

## Research Archive

| Documento | Versión | Fecha | DOI | PDF |
|---|---|---|---|---|
...
El historial de problemas encontrados y sus resoluciones está documentado en
[CHANGELOG.md](CHANGELOG.md): cada revisión queda registrada con su versión,
su problema y su resolución.

## Sitio web

**https://mateomoreira-uy.github.io/time-is-motion/**

El sitio vive en este mismo repositorio (GitHub Pages): `index.html`, bilingüe
EN/ES, con la animación T≡M en canvas (sin dependencias, 15KB).
...
- **Documentos (papers/)**: CC BY 4.0 · **Tempo Symbol Identity**: CC BY-NC 4.0 (ver [LICENSE-papers.md](LICENSE-papers.md))
- **Código (sitio y animación)**: MIT (ver [LICENSE](LICENSE))
